...
public class ShareToSCA {
     ...
     * @param desc
     */
    public static void shareQQContentUrl(Activity context, ArrayList<Uri> uris, String desc) {
        if (!checkPermission(context)) {
            return;
        }
        Intent intent = new Intent();
     ...
     * @param desc
     */
    public static void shareWechatMomentsContentUrl(Activity context, ArrayList<Uri> uris, String desc) {
        Intent intent = new Intent();
